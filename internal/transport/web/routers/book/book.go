...
func (br *bookRouter) BookRegRouters(ctx context.Context, gr *gin.RouterGroup) {
	...
	Books := gr.Group("/books")
	{
		...
		Books.GET("/all", func(c *gin.Context) { br.bh.AllBooks(c.Request.Context(), c) })
		Books.GET("/my", func(c *gin.Context) { br.bh.AllMyBooks(c.Request.Context(), c) })
		Books.GET("/:id", func(c *gin.Context) { br.bh.BookById(c.Request.Context(), c) })
